...
def generate_settings_file(exa_files: List[str], exa_problem_path: str, problem_name: str, output_path: str,
                           target_code_path: str, build_file_generator: str, build_target_name: str,
                           build_standalone: bool, overwrite: bool, use_cuda: bool, use_likwid: bool,
                           use_likwid_perfctr: bool):
    ...
    if not os.path.isfile(settings_path) or overwrite:
        print_settings_file(exa_files, exa_problem_path, problem_name, settings_path, output_path,
            target_code_path, build_file_generator, build_target_name, build_standalone,
            use_cuda, use_likwid, use_likwid_perfctr)
    else:
        raise ValueError(
...
def print_settings_file(exa_files: List[str], exa_problem_path: str, exa_problem_name: str, settings_path: str,
                        output_path: str, target_code_path: str, build_file_generator: str, build_target_name: str,
