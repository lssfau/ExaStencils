...
object MuncherList {
  ...
  if (true) { // in exastencils.communication
  ...
  if (true) { // in exastencils.deprecated
  ...
  if (true) { // in exastencils.stencil
  ...
  if (true) { // in exastencils.layoutTransformation
  ...
  if (true) { // in exastencils.globals
  ...
  if (true) { // in exastencils.interfacing
