...
case class L4_WaLBerlaFieldLayoutDecl(
...
) extends L4_FieldLikeLayoutDecl[L4_WaLBerlaFieldLayout, IR_WaLBerlaFieldLayout] {
  ...
  override def associatedCollection : L4_FieldLikeLayoutCollection[L4_WaLBerlaFieldLayout, IR_WaLBerlaFieldLayout] = L4_WaLBerlaFieldLayoutCollection
}
