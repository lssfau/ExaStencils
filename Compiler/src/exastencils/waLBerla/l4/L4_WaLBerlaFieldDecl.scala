...
case class L4_WaLBerlaFieldDecl(
  ...
  override def addToKnowledge() : Unit = {
    ...
    val wbField = L4_WaLBerlaField(name, levels.get.resolveLevel, index, fieldLayout.asInstanceOf[L4_WaLBerlaFieldLayoutAccess].target, boundary.getOrElse(L4_NoBC), matShape)
