...
object Knowledge {
  ...
  /// functionality test
  var l3tmp_exactSolution : String = "Polynomial" // specifies which function (type) is used for the solution/ rhs is used; allowed options are 'Zero', 'Polynomial', 'Trigonometric' and 'InvSqrt'
