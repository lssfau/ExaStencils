...
object L4_DefaultRestrictionStencil {
  def apply(name : String, levels : Option[L4_LevelSpecification], localization : String, interpolation : String) =
    new L4_DefaultRestrictionStencil(name, levels, Knowledge.dimensionality, localization, interpolation)
}
...
case class L4_DefaultRestrictionStencil(
  ...
  override def generateStencil() = {
    L4_DefaultRestriction.generate(name, levels.get.asInstanceOf[L4_SingleLevel].level,
...
object L4_DefaultProlongationStencil {
  def apply(name : String, levels : Option[L4_LevelSpecification], localization : String, interpolation : String) =
    new L4_DefaultProlongationStencil(name, levels, Knowledge.dimensionality, localization, interpolation)
}
...
case class L4_DefaultProlongationStencil(
  ...
  override def generateStencil() = {
    L4_DefaultProlongation.generate(name, levels.get.asInstanceOf[L4_SingleLevel].level,
      numDims, localization, interpolation)
  }
