...
object IR_DefaultLayerHandler extends IR_LayerHandler {
  ...
  override def schedule() : Unit = {
    ...
    /*
    if (Knowledge.waLBerla_generateInterface && Knowledge.waLBerla_generateCommSchemes)
    ...
    */
    ...
    /*
    if (Knowledge.waLBerla_generateInterface && Knowledge.cuda_enabled && Knowledge.waLBerla_useFixedLayoutsFromExa)
