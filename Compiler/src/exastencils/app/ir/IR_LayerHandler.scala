...
object IR_DefaultLayerHandler extends IR_LayerHandler {
  ...
  override def handle() : Unit = {
    ...
    while (sthChanged) {
      ...
      sthChanged = (IR_ResolveMatrixOperations.results.last._2.matches > 0 |
        IR_ResolveMatrixDeclarations.results.last._2.matches > 0 |
        IR_ResolveMatrixAssignments.results.last._2.matches > 0 |
        IR_HandleRuntimeMatrices.results.last._2.matches > 0)
    }
