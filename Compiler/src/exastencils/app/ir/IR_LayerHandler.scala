...
object IR_DefaultLayerHandler extends IR_LayerHandler {
  ...
  override def handle() : Unit = {
    ...
    // TODO: keep strategy calls to a minimum
    IR_WaLBerlaReplaceFragmentLoops.apply() // before first expand
   ...
   IR_PreItMOps.apply()
    ...
    IR_WaLBerlaReplaceFragmentLoops.apply() // frag loops in apply bc
    IR_WaLBerlaSetupCommunication.apply()
