...
// FIXME: op -> BinOp
case class L4_RelativeLevel(var op : String, var base : L4_LevelSpecification, var offset : Int) extends L4_DeclarationLevelSpecification with L4_AccessLevelSpecification {
