...
object L1_FunctionCall {
  def apply(function : L1_FunctionReference, arguments : Option[List[L1_Expression]]) =
    new L1_FunctionCall(function, arguments.getOrElse(List()).to[ListBuffer])
...
case class L1_FunctionCall(var function : L1_FunctionReference, var arguments : ListBuffer[L1_Expression]) extends L1_Expression {
  ...
  def progress = L2_FunctionCall(function.progress, arguments.map(_.progress))
