  ...
  def apply(a : IR_Datatype, b : IR_Datatype) : IR_Datatype = {
    ...
    a match {
      case IR_IntegerDatatype          => b match {
        ...
        case IR_TensorDatatype1(dt)      => IR_TensorDatatype1(dt)
        case IR_TensorDatatype2(dt)      => IR_TensorDatatype2(dt)
        case IR_TensorDatatypeN(dt, 1)   => IR_TensorDatatype1(dt)
        case IR_TensorDatatypeN(dt, 2)   => IR_TensorDatatype2(dt)
        case IR_TensorDatatypeN(dt, ord) => IR_TensorDatatypeN(dt, ord)
      }
      case IR_RealDatatype             => b match {
        ...
        case IR_TensorDatatype1(dt)      => IR_TensorDatatype1(IR_ResultingDatatype(dt, a))
        case IR_TensorDatatype2(dt)      => IR_TensorDatatype2(IR_ResultingDatatype(dt, a))
        case IR_TensorDatatypeN(dt, 1)   => IR_TensorDatatype1(IR_ResultingDatatype(dt, a))
        case IR_TensorDatatypeN(dt, 2)   => IR_TensorDatatype2(IR_ResultingDatatype(dt, a))
        case IR_TensorDatatypeN(dt, ord) => IR_TensorDatatypeN(IR_ResultingDatatype(dt, a), ord)
      }
      ...
      case IR_StringDatatype           => b match {
        ...
        case IR_TensorDatatype1(dt)      => IR_StringDatatype
        case IR_TensorDatatype2(dt)      => IR_StringDatatype
        case IR_TensorDatatypeN(dt, ord) => IR_StringDatatype
      }
      ...
      case IR_TensorDatatype1(dt)      => IR_TensorDatatype1(IR_ResultingDatatype(dt, a.resolveBaseDatatype))
      case IR_TensorDatatype2(dt)      => IR_TensorDatatype2(IR_ResultingDatatype(dt, a.resolveBaseDatatype))
      case IR_TensorDatatypeN(dt, 1)   => IR_TensorDatatype1(IR_ResultingDatatype(dt, a.resolveBaseDatatype))
      case IR_TensorDatatypeN(dt, 2)   => IR_TensorDatatype2(IR_ResultingDatatype(dt, a.resolveBaseDatatype))
      case IR_TensorDatatypeN(dt, ord) => IR_TensorDatatypeN(IR_ResultingDatatype(dt, a.resolveBaseDatatype), ord)
