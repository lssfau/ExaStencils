...
case class IR_LocalSend(
  ...
  override def expand() : Output[IR_Statement] = {
    var innerStmt : IR_Statement = IR_Assignment(
      IR_DirectFieldAccess(IR_FieldSelection(field.field, field.level, Duplicate(field.slot), IR_IV_NeighborFragmentIdx(field.domainIndex, neighbor.index)), IR_ExpressionIndex(
