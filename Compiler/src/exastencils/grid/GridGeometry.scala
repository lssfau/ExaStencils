...
abstract class GridGeometry() {
  ...
  def nodePosition(level : Expression, index : MultiIndex, componentIndex : ConstIndex, dim : Int) : Expression
  def cellCenter(level : Expression, index : MultiIndex, componentIndex : ConstIndex, dim : Int) : Expression

  def cellWidth(level : Expression, index : MultiIndex, componentIndex : ConstIndex, dim : Int) : Expression
  def gridWidth(level : Expression, index : MultiIndex, componentIndex : ConstIndex, dim : Int) : Expression = cellWidth(level, index, componentIndex, dim) // simple alias for most grids

  def cellVolume(level : Expression, index : MultiIndex, componentIndex : ConstIndex) : Expression = {
  ...
  def cellCenterToFace(level : Expression, index : MultiIndex, componentIndex : ConstIndex, dim : Int) : Expression = { 0.5 * cellWidth(level, index, componentIndex, dim) }
...
trait GridGeometry_uniform extends GridGeometry {
  ...
  override def cellWidth(level : Expression, index : MultiIndex, componentIndex : ConstIndex, dim : Int) : Expression = {
  ...
  override def nodePosition(level : Expression, index : MultiIndex, componentIndex : ConstIndex, dim : Int) : Expression = {
  ...
  override def cellCenter(level : Expression, index : MultiIndex, componentIndex : ConstIndex, dim : Int) : Expression = {
...
trait GridGeometry_nonUniform extends GridGeometry {
  // direct accesses
  override def nodePosition(level : Expression, index : MultiIndex, componentIndex : ConstIndex, dim : Int) = {
  ...
  // compound accesses
  override def cellCenter(level : Expression, index : MultiIndex, componentIndex : ConstIndex, dim : Int) = {
  ...
  override def cellWidth(level : Expression, index : MultiIndex, componentIndex : ConstIndex, dim : Int) = {
...
trait GridGeometry_staggered extends GridGeometry {
  ...
  def stagCVWidth(level : Expression, index : MultiIndex, componentIndex : ConstIndex, dim : Int) : Expression // depends on uniform property

  // compound accesses
  def staggeredCellVolume(level : Expression, index : MultiIndex, componentIndex : ConstIndex, stagDim : Int) = {
    var exp : Expression = (
      if (0 == stagDim)
  ...
  def xStagCellVolume(level : Expression, index : MultiIndex, componentIndex : ConstIndex) : Expression = staggeredCellVolume(level, index, componentIndex, 0)
  def yStagCellVolume(level : Expression, index : MultiIndex, componentIndex : ConstIndex) : Expression = staggeredCellVolume(level, index, componentIndex, 1)
  def zStagCellVolume(level : Expression, index : MultiIndex, componentIndex : ConstIndex) : Expression = staggeredCellVolume(level, index, componentIndex, 2)
}
...
object GridGeometry_uniform_staggered_AA extends GridGeometry_uniform with GridGeometry_staggered {
  // direct accesses
  override def stagCVWidth(level : Expression, index : MultiIndex, componentIndex : ConstIndex, dim : Int) = {
