...
case class ImplVariable(name : String, vartype : TypeInfo, ScopeInfo : String) extends Expression() {
...
case class ImplVariableWLev(name : String, vartype : TypeInfo, lev : Expression, ScopeInfo : String) extends Expression() {
  override def duplicate = this.copy().asInstanceOf[this.type]
